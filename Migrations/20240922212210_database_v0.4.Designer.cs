...
namespace net_core_web_api_clean_ddd.Migrations
{
    ...
    [Migration("20240922212210_database_v0.4")]
    partial class database_v04
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("net_core_web_api_clean_ddd.Domain.Entities.ProductEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("net_core_web_api_clean_ddd.Domain.Entities.ProductEntity", b =>
                {
                    b.HasOne("net_core_web_api_clean_ddd.Domain.Entities.CategoryEntity", "Category")
                        .WithMany()
